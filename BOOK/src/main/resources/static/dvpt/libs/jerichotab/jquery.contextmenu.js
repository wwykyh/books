...
(function($) {
    ...
    $.fn.contextmenu = function(option) {
        ...
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr unselectable=on><img src='$[icon]' alt='' align='absmiddle'/><span unselectable=on>$[text]</span></nobr></div>";
        ...
        function showMenu(e, menutarget) {
            ...
            if($("iframe").length > 0){
                $("iframe").contents().one('mousedown', hideMenuPane);
            }
        }

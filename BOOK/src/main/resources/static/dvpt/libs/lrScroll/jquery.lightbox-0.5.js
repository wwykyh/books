...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading: $.fn.contextPath+	'widgets-src/duceap/themes/default/images/lightBox/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:		$.fn.contextPath+	'widgets-src/duceap/themes/default/images/lightBox/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:		$.fn.contextPath+	'widgets-src/duceap/themes/default/images/lightBox/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:	$.fn.contextPath+	'widgets-src/duceap/themes/default/images/lightBox/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:		$.fn.contextPath+	'widgets-src/duceap/themes/default/images/lightBox/lightbox-blank.gif',

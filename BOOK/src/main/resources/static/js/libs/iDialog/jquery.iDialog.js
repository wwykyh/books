...
~function($, window, undefined) {
    var win = $(window.parent),
        ...
        ie6 = ie && version < 7,
        dialog,
        dialogZindex = (window.parent.dialogZindex) ? window.parent.dialogZindex : 1e4;
        // console.log(window.parent.dialogZindex);
    ...
    drag.fn = drag.prototype = {
        init: function(options) {
            ...
            var that           = this,
            ie6fix             = '(document.documentElement || window.parent.document.body)';
    ...
    dialog.fn = dialog.prototype = {
        ...
        lock: function() {
            ...
            window.parent.dialogZindex = dialogZindex;
        },
        createHTML: function() {
        ...
        content: function(content) {
            ...
            if(this.url) {
                this.$content.html(
                    '<iframe src='+this.url+' width="100%" height="'+ (this.height - 32)+'px" scrolling="no" frameborder="0"></iframe>');

define(['jquery'], function($) {
    ...
    $.Poshytip.prototype = {
        ...
        update: function(content, dontOverwriteOption) {
            ...
            var self = this,
            newContent = typeof content == 'function' ? content.call(this.$elm[0],
            function(newContent) {
        ...
        calcPos: function() {
            ...
            case 'inner-left':
                ...
                if (this.opts.keepInViewport && pos.l + this.tipOuterW > win.l + win.w) pos.l = win.l + win.w - this.tipOuterW;
            ...
            default:
                ...
                if (this.opts.keepInViewport && pos.l < win.l) pos.l = win.l;
            ...
            case 'center':
                ...
                if (this.opts.keepInViewport) {
                    if (pos.t + this.tipOuterH > win.t + win.h) pos.t = win.t + win.h - this.tipOuterH;
    ...
    $.fn.poshytip = function(options) {
        ...
        if (opts.liveEvents && opts.showOn != 'none') {
            ...
            case 'focus':
                handler = function() {
                    var $this = $(this);
                    if (!$this.data('poshytip')) $this.poshytip(deadOpts).poshytip('showDelayed');
                };
     ...
     * @param { Number } showOn 提示工具条触发方式，有'hover', 'focus', 'none'三种方式
     * @param { Boolean } liveEvent 使用存在的事件
     ...
     * @param { Boolean } keepInViewport 允许鼠标滑向工具条上方

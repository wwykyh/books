...
define(['jquery'],function(b) {
	...
	/**
	 * iCheck
	 * @param  checkboxClass 复选框类
	 * @param  radioClass 单选框类
	 * @param  checkedClass 选中类
	 * @param  disabledClass 禁选类
	 * @param  hoverClass 鼠标悬浮效果
	 * @param  focusClass 焦点效果
	 * @param  activeClass 选中效果
     * @param  increaseArea 定位距离 默认为20%
            ...
            return this.each(function() {
                (b(this).is(c) ? b(this) : b(this).find(c)).each(function() {
                    ...
                    var a = this,
                        ...
                        r = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini/i.test(k) ? { position: "absolute", visibility: "hidden" } : e | 0 ? f : { position: "absolute", opacity: 0 },

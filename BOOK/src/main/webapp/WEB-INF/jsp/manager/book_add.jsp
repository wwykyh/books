...
<body>
    <div class="panel">
        ...
        <div class="panel-body panel-noborder">
            <div class="write-box">
                <form action="bookAdd" method="post" class="form-libs" onsubmit="return sub();" name="form-libs" id="form-libs">
                <table class="form-table" width="100%">
                    <tr>
                        <th width="17%"><span class="ft-need">*</span>图书ISBN：</th>
                        <td width="33%"><input id="isbn" name="book.isbn" data-validate="required number" type="text" class="input-text " onBlur="getBookInfo();" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input id="cbrq" name="book.cbrq" vdata-validate="required" type="text" class="input-text" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input id="userId" name="store.userId" data-validate="required number" type="text"  class="input-text"></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        function sub() {
            $.ajax({
                ...
                type: "POST",
                url:"bookAdd",
                data:$('#form-libs').serialize(),// 你的form id
                async: false,
        ...
        function getBookInfo() {
           var isbn = $("#isbn").val() ;
            $.ajax({url:"${pageContext.request.contextPath}/getBookInfo?isbn="+isbn,success:function(data){

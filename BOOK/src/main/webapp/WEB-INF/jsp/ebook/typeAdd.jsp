        ...
        <div class="panel-body panel-noborder">
            <div class="write-box">
                ...
                <table class="form-table" width="100%">
                    <tr>
                        <th width="17%"><span class="ft-need">*</span>电子书类型名称：</th>
                        <td width="33%"><input id="ebookTypemc" name="ebookTypemc" data-validate="required" type="text" class="input-text "></td>
                    </tr>
                    <tr>

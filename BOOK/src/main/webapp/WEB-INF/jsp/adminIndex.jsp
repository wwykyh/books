...
<link rel="stylesheet" type="text/css"
	href="css/common/iconfont/iconfont.css" />
...
<script type="text/javascript">
	requirejs([ 'main' ], function(main) {
		requirejs([ 'jquery', 'jquery.extend', 'basic-global' ], function(
				jquery, extend, basic) {
			// 计算高度
			...
			<div id="sidebar">
				<div class="sidebar-list">
					...
					<dl>
						...
						<dd>
							<ul>
								<li><a _href="审核列表.html" data-name="审核列表"
									data-js="prettify" href="javascript:;">审核列表</a></li>
					...
					<dl>
						<dt>
							<a href="javascript:;"> <i class="icon">&#xe6b3;</i><span>图书</span>
								<i class="icon arrow">&#xe658;</i> <i class="icon arrow hide">&#xe659;</i>
							</a>
						</dt>
						<dd>
							<ul>
								<li><a _href="图书管理.html" data-name="图书管理"
									href="javascript:;">图书管理</a></li>
								<li><a _href="资产.html" data-name="资产" href="javascript:;">资产</a></li>
								<li><a _href="图书分析.html" data-name="图书分析"
									href="javascript:;">图书分析</a></li>
								<li><a _href="库存管理.html" data-name="库存管理"
									href="javascript:;">库存管理</a></li>
								<li><a _href="借阅历史.html" data-name="借阅历史"
									href="javascript:;">借阅历史</a></li>
								<li><a _href="图书类型管理.html" data-name="图书种类管理"
									href="javascript:;">图书种类管理</a></li>
								<li><a _href="图书类型管理.html" data-name="出版社管理"
									href="javascript:;">出版社管理</a></li>
